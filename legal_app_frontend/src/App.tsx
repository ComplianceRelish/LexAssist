// CORRECTED: legal_app_frontend/src/App.tsx
...
function App() {
  ...
  // Protected route wrapper - BYPASSED  // Protected route component
  const ProtectedRoute = ({ children }: { children: React.ReactNode }) => {
    // Allow access if user is logged in, otherwise redirect to register page
    if (!user) {
  ...
  return (
    <ChakraProvider theme={theme}>
      <BrandProvider>
        {/* ✅ CORRECTED: Move AuthProvider outside BrowserRouter */}
        <AuthProvider>
          <BrowserRouter>
            <Routes>
              {/* Public routes */}
